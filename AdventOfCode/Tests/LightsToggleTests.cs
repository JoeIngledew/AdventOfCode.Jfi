namespace AdventOfCode.Tests
{
    ...
    [TestClass]
    public class LightsToggleTests
    {
        [TestMethod]
        public void Test1()
        {
            var command = "turn on 0,0 through 999,999";

            var lt = new LightsToggle();

            var actual = lt.InterpretInstructionAndGetLightsLit(command);
        ...
        public void ActualScenario()
        {
            ...
            var actual = lt.InterpretInstructionAndGetLightsLit(instructions);

            Assert.AreEqual(1, actual);
        }

        string instructions = @"toggle 461,550 through 564,900
