...
ioxxoj[asdfgh]zxcvbn";
            ...
            var ivs = new IpVerSeven();

            Assert.Equal(2, ivs.GetNumberOfIpsThatSupportTls(input));
        }
        ...
        public void ActualIpTest()
        {
            ...
            Assert.Equal(2, ivs.GetNumberOfIpsThatSupportSsl(input));
        }

        private string actualIn = @"rhamaeovmbheijj[hkwbkqzlcscwjkyjulk]ajsxfuemamuqcjccbc
